...
export const presetSpaceTourism: Preset = {
  ...
  shortcuts: {
    ...
    'bg-home-desktop': 'bg-[url("/imgs/home/background-home-desktop.jpg")]',
    'bg-home-tablet': 'bg-[url("/imgs/home/background-home-tablet.jpg")]',
    'bg-home-mobile': 'bg-[url("/imgs/home/background-home-mobile.jpg")]',
    'bg-destination-desktop': 'bg-[url("/imgs/destination/background-destination-desktop.jpg")]',
    'bg-destination-tablet': 'bg-[url("/imgs/destination/background-destination-tablet.jpg")]',
    'bg-destination-mobile': 'bg-[url("/imgs/destination/background-destination-mobile.jpg")]',
    'bg-crew-desktop': 'bg-[url("/imgs/crew/background-crew-desktop.jpg")]',
    'bg-crew-tablet': 'bg-[url("/imgs/crew/background-crew-tablet.jpg")]',
    'bg-crew-mobile': 'bg-[url("/imgs/crew/background-crew-mobile.jpg")]',
    'bg-technology-desktop': 'bg-[url("/imgs/technology/background-technology-desktop.jpg")]',
    'bg-technology-tablet': 'bg-[url("/imgs/technology/background-technology-tablet.jpg")]',
    'bg-technology-mobile': 'bg-[url("/imgs/technology/background-technology-mobile.jpg")]',
